 ...
 * pseudorandom values.  Class {@link L32X64StarStarRandom} implements
 * interfaces {@link RandomGenerator} and {@link SplittableGenerator},
 * and therefore supports methods for producing pseudorandomly chosen
 * numbers of type {@code int}, {@code long}, {@code float}, and {@code double}
 * as well as creating new split-off {@link L32X64StarStarRandom} objects.

 * <p>The {@link L32X64StarStarRandom} algorithm is a specific member of
 * the LXM family of algorithms for pseudorandom number generators;
 * for more information, see the documentation for package
 * {@link java.util.random}.  Each instance of {@link L32X64StarStarRandom}
 * has 96 bits of state plus one 32-bit instance-specific parameter.
 *
 * <p>If two instances of {@link L32X64StarStarRandom} are created with
 ...
 * {@link L32X64StarStarRandom} are <em>not</em> thread-safe.  They are
 ...
 * {@code new Subtask(someL32X64StarStarRandom.split()).fork()}.
 *
 * <p>This class provides additional methods for generating random
 * streams, that employ the above techniques when used in
 * {@code stream.parallel()} mode.
 *
 * <p>Instances of {@link L32X64StarStarRandom} are not cryptographically
 ...
 * @since   16
 */
public final class L32X64StarStarRandom extends AbstractSplittableWithBrineGenerator {
     ...
     * two instances of {@link L32X64StarStarRandom} will be (approximately)
     ...
     */
    public L32X64StarStarRandom(int a, int s, int x0, int x1) {
        // Force a to be odd.
        this.a = a | 1;
        this.s = s;
    ...
    /**
     * Creates a new instance of {@link L32X64StarStarRandom} using the
     * specified {@code long} value as the initial seed. Instances of
     * {@link L32X64StarStarRandom} created with the same seed in the same
     * program generate identical sequences of values.
     *
     * @param seed the initial seed
     */
    public L32X64StarStarRandom(long seed) {
    ...
    /**
     * Creates a new instance of {@link L32X64StarStarRandom} that is likely to
     * generate sequences of values that are statistically independent
     * of those of any other instances in the current program execution,
     * but may, and typically does, vary across program invocations.
     */
    public L32X64StarStarRandom() {
        // Using GOLDEN_RATIO_64 here gives us a good Weyl sequence of values.
        this(defaultGen.getAndAdd(RandomSupport.GOLDEN_RATIO_64));
    }

    /**
     * Creates a new instance of {@link L32X64StarStarRandom} using the specified array of
     * initial seed bytes. Instances of {@link L32X64StarStarRandom} created with the same
     * seed array in the same program execution generate identical sequences of values.
     *
     * @param seed the initial seed
     */
    public L32X64StarStarRandom(byte[] seed) {
     ...
     * {@code L32X64StarStarRandom} that shares no mutable state with this instance.
     ...
     * a single {@code L32X64StarStarRandom} object.  Either or both of the two
     ...
     * @return a new instance of {@code L32X64StarStarRandom}
     */
    public L32X64StarStarRandom split(SplittableGenerator source, long brine) {
	// Pick a new instance "at random", but use (the low 31 bits of) the brine for `a`.
        return new L32X64StarStarRandom((int)brine << 1, source.nextInt(),
	...
	// (this allows the computation to be overlapped with state update).
        final int result = Integer.rotateLeft((s + x0) * 5, 7) * 9;  // "starstar" scrambler
