 ...
 */
  ...
  * that is <it>k</it>-equidistributed such that <it>k</it> is at least as large as the length of the tuples being generated.
  ...
  * <it>k</it>-equidistribution for some <it>k</it> greater than 1, meaning that successive
  * non-overlapping <it>k</it>-tuples of 64-bit values produced by the {@code nextLong()} method
  ...
  * </thead>
  * <tbody>
  *   <tr><td>{@link java.util.random.L32X64StarStarRandom}<td>2<sup>32</sup>(2<sup>64</sup>-1)</td><td>96 bits</dt><td>32 bits</dt><td></dt></tr>
  *   <tr><td>{@link java.util.random.L32X64MixRandom}<td>2<sup>32</sup>(2<sup>64</sup>-1)</td><td>96 bits</dt><td>32 bits</dt><td></dt></tr>
  *   <tr><td>{@link java.util.random.L64X128StarStarRandom}<td>2<sup>64</sup>(2<sup>128</sup>-1)</td><td>192 bits</dt><td>64 bits</dt><td>2-equidistributed and exactly equidistributed</dt></tr>
  *   <tr><td>{@link java.util.random.L64X128MixRandom}<td>2<sup>64</sup>(2<sup>128</sup>-1)</td><td>192 bits</dt><td>64 bits</dt><td>2-equidistributed and exactly equidistributed</dt></tr>
  *   <tr><td>{@link java.util.random.L64X256MixRandom}<td>2<sup>64</sup>(2<sup>256</sup>-1)</td><td>320 bits</dt><td>64 bits</dt><td>4-equidistributed and exactly equidistributed</dt></tr>
  *   <tr><td>{@link java.util.random.L64X1024MixRandom}<td>2<sup>64</sup>(2<sup>1024</sup>-1)</td><td>1088 bits</dt><td>64 bits</dt><td>16-equidistributed and exactly equidistributed</dt></tr>
  *   <tr><td>{@link java.util.random.L128X128MixRandom}<td>2<sup>128</sup>(2<sup>128</sup>-1)</td><td>256 bits</dt><td>128 bits</dt><td>exactly equidistributed</dt></tr>
  *   <tr><td>{@link java.util.random.L128X256MixRandom}<td>2<sup>128</sup>(2<sup>256</sup>-1)</td><td>384 bits</dt><td>128 bits</dt><td>exactly equidistributed</dt></tr>
  *   <tr><td>{@link java.util.random.L128X1024MixRandom}<td>2<sup>128</sup>(2<sup>1024</sup>-1)</td><td>1152 bits</dt><td>128 bits</dt><td>exactly equidistributed</dt></tr>
  * <tbody>
  * </table>
  *
  ...
  * the 64-bit values produced by the {@code nextLong()} method are <it>exactly equidistributed</it>:
  ...
  * the 64-bit values produced by the {@code nextLong()} method are <it>k</it>-equidistributed</it>
  * (but not exactly <it>k</it>-equidistributed</it>).
