...
public abstract class InetNameServiceProvider {
    ...
    public interface NameService {
        ...
        /**
         * Given the name of a host, returns an array of IP addresses of the requested
         ...
         *
         */
        InetAddress[] lookupInetAddresses(String host, ProtocolFamily family) throws UnknownHostException;
         ...
         *
         * @param addr byte array representing an raw IP address
