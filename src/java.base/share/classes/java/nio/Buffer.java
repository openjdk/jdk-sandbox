...
public abstract class Buffer {
    ...
    // True if the native order is big-endian
     ...
     */
    @IntrinsicCandidate
    private final int checkIndex(int i) {               // package-private
        if ((i < 0) || (i >= limit))
    ...
    static {
        ...
        SharedSecrets.setJavaNioAccess(
            new JavaNioAccess() {
                ...
                @Override
                public ByteBuffer newMappedByteBuffer(UnmapperProxy unmapperProxy, long address, int cap, Object attachment, MemorySegmentProxy segment) {
                ...
                public ByteBuffer newHeapByteBuffer(byte[] hb, int offset, int capacity, MemorySegmentProxy segment) {
                    return new ByteBuffer(Unsafe.ARRAY_BYTE_BASE_OFFSET + offset, hb,
