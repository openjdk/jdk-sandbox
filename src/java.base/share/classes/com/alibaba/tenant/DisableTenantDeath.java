...
/**
 * this annotation can protect a method or constructor from tenant death kill. This annotation also
 * disables inlining for the method to which it is applied unless the
 * method being inlined into is also annotated DisableTenantDeath.
...
public @interface DisableTenantDeath {
}
