...
static JNINativeMethod methods[] = {
    {"prepareForDestroy0",      "(ZZ)V",            (void *)&JVM_TenantPrepareForDestroy },
    {"wakeUpTenantThread",      "(" THREAD ")V",    (void *)&JVM_WakeUpTenantThread },
    {"maskTenantShutdown0",     "(" THREAD ")V",    (void *)&JVM_MaskTenantShutdown },
    {"unmaskTenantShutdown0",   "(" THREAD ")V",    (void *)&JVM_UnmaskTenantShutdown },
    {"dumpThreads",             "([" THREAD ")V",   (void *)&JVM_DumpTenantThreadStacks },
    {"hasTenantDeathException", "(" THREAD ")Z",    (void *)&JVM_IsKilledByTenant },
    {"setTenantDeathToVThread", "(" THREAD ")V",    (void *)&JVM_SetTenantDeathToVThread }
};
