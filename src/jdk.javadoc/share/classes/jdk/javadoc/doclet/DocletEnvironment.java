...
public interface DocletEnvironment {
    ...
    /// Returns the elements [specified][jdk.javadoc.doclet##specified] when
    /// the tool is invoked.
    ///
    ...
    /// [included][jdk.javadoc.doclet##included] in the documentation.
    ///
    ...
    /// This class provides methods to access `TreePath`s, `DocCommentTree`s
    /// and so on.
    ///
    ...
    /// This class provides methods for operating on
    /// [`type mirrors`][javax.lang.model.type.TypeMirror].
    ///
    ...
    /// Returns true if the element is [selected][jdk.javadoc.doclet##selected].
    /// 
    /// @param e the element
