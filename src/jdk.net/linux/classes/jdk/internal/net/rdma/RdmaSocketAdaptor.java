...
//qwe        super(DummySocketImpl.create());
    ...
    static Socket create(RdmaSocketChannelImpl sc) {
        PrivilegedExceptionAction<Socket> pa = () -> new RdmaSocketAdaptor(sc);
        try {
    ...
    public void connect(SocketAddress remote, int timeout) throws IOException {
        ...
        try {
            ...
            RdmaNet.translateException(e, true);
        }
    }
    ...
    public SocketAddress getLocalSocketAddress() {
        InetSocketAddress local = sc.localAddress();
        if (local != null) {
            return RdmaNet.getRevealedLocalAddress(local);
        } else {
            return null;
        }
    }
    ...
    public InputStream getInputStream() throws IOException {
        ...
        return new InputStream() {
            ...
            public int read(byte[] b, int off, int len) throws IOException {
                int timeout = RdmaSocketAdaptor.this.timeout;
                if (timeout > 0) {
                    long nanos = MILLISECONDS.toNanos(timeout);
