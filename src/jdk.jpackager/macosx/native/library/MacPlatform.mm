...
TString MacPlatform::getTmpDirString() {
    return TString(MAC_JPACKAGER_TMP_DIR);
}
...
// Convert parts of the info.plist to the INI format the rest of the jpackager
// uses unless a jpackager config file exists.
