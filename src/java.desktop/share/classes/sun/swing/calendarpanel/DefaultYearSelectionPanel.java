...
public final class DefaultYearSelectionPanel extends AbstractCalendarPanel {
    ...
    public void updateCalendar() {
        ...
        tableModel.updateYearViewLimit(calendarPanel.getYearSelectionLimit());
    ...
    public void buildCalendar() {
        ...
        SortedSet<Integer> yearSelectionLimit = calendarPanel.getYearSelectionLimit();
        tableModel = new YearTableViewModel(yearSelectionLimit);
    ...
    private void setupYearSelection() {
        SortedSet<Integer> selectionLimitRange = calendarPanel.getYearSelectionLimit();
        calendarTable.setModel(new YearTableViewModel(selectionLimitRange));
