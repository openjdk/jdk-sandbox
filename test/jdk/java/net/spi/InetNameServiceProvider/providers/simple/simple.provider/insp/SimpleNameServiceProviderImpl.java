...
public class SimpleNameServiceProviderImpl extends InetNameServiceProvider {
    ...
    private static Logger LOGGER = Logger.getLogger(SimpleNameServiceProviderImpl.class.getName());
