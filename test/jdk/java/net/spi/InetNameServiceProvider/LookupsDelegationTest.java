...
import insp.DelegatingProviderImpl;
...
import static insp.DelegatingProviderImpl.changeReverseLookupAddress;
import static insp.DelegatingProviderImpl.lastReverseLookupThrowable;

/*
 * @test
 * @summary checks delegation of lookup requests to a built-in InetAddress
 *  resolver.
 * @library providers/delegating
 * @build delegating.provider/insp.DelegatingProviderImpl
 * @run testng/othervm LookupsDelegationTest
 */
public class LookupsDelegationTest {
