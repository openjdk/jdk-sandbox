...
public class ASGSTStabilityTest {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // ClassLoader cl = new URLClassLoader(new URL[]{jarPath.toUri().toURL()}, ASGSTStabilityTest.class.getClassLoader());
    // Class<?> clz = cl.loadClass(MAIN_CLASS);
    // Method main = clz.getMethod("main", String[].class);

    // String[] benchmarks = new String[] {
    //   "finagle-chirper", "finagle-http", "akka-uct"
    // };
    ...
    // String[] benchmarkArgs = new String[] {"dummy", "-t", Integer.toString(testDuration)};
    // for (String benchmark : benchmarks) {
    //   System.out.println("=== Going to run '" + benchmark + "' benchmark for " + testDuration + " seconds ...");
    //   benchmarkArgs[0] = benchmark;
    //   main.invoke(null, (Object)benchmarkArgs);
    //   System.out.println("=== ... done");
    // }
  }
}
