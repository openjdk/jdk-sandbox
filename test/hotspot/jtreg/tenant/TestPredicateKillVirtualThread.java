 ...
 *                               -XX:+TraceTenantKillThreads -XX:+MultiTenant -XX:+TenantThreadStop -XX:+TenantCpuAccounting -XX:+ThreadPoolTenant
 *                               -Dcom.alibaba.tenant.ShutdownSTWSoftLimit=10000 -Dcom.alibaba.tenant.DebugTenantShutdown=true -Dcom.alibaba.tenant.PrintStacksOnTimeoutDelay=60000
 *                               --add-opens=java.base/jdk.internal.access=ALL-UNNAMED
 *                               --add-opens=java.base/java.lang=ALL-UNNAMED TestPredicateKillVirtualThread
 *
 */
